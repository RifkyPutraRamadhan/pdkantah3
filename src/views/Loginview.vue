<template>
  <div>
    <div v-if="errorMessage" class="mt-3 text-danger">{{ errorMessage.value }}</div>
    <section>
          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <form @submit.prevent="masuk">
              ...
              <div class="form-outline mb-3">
                <input v-model="password" type="password" id="form3Example4" class="form-password form-control form-control-lg" placeholder="Masukkan Kata sandi" />
              </div>
			        <input type="checkbox" class="form-checkbox"> Tampilkan kata sandi
              <div align="center">
            <p>Tidak memiliki akun ?<a href="/registrasi"> Daftar disini</a></p>
            </div>
