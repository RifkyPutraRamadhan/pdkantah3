      ...
      <div class="col">
        <div class="row">
          <div class="col mb-3">
            <div class="card">
              <div class="card-body">
                <h1 align="center">Entri Data Pengembalian Berkas</h1>
                <form @submit.prevent="addPengembalianBerkas">
                  <div class="mb-3">
                    <label for="tanggal_kembali" class="form-label">Tanggal Pinjam</label>
                    <input v-model="tanggal_kembali" type="datetime-local" class="form-control" id="tanggal_kembali" required>
                  </div>
                  <div class="mb-3">
                  ...
                  <div class="row">
                    <div class="col d-flex justify-content-end">
                      <router-link to="/pengembalianberkas" name="kembali" class="btn btn-danger mb-3 me-2">KEMBALI</router-link>
...
export default {
  setup() {
    const tanggal_kembali = ref(null);
    ...
    const addPengembalianBerkas = async () => {
      ...
      if (error) {
        ...
        console.log(data);
        router.push("/pengembalianberkas");
      }
    };
